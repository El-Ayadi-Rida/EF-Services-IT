        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="row gx-4">
              ...
              <Col>
                <NavLink to="/accueil/bac-predictor" className="heading stretched-link d-block">
                  Prédisez vos notes de baccalauréat
                </NavLink>
                <div className="text-muted">Grâce à notre outil, évaluez vos performances scolaires et obtenez une estimation de vos futures notes de baccalauréat.</div>
              </Col>
            </Card.Body>
          </Card>
        </Col>
